...
from granpybot.run. import Parser
from granpybot.GoogleMapApi import GoogleMapApi
from granpybot.WikipediaApi import WikipediaApi
...
class TestApiRequests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api_gm = GoogleMapApi('key')
        self.wiki_api = WikipediaApi()

    @patch('granpybot.GoogleMapApi.requests.get')
